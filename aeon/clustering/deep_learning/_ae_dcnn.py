...
class AEDCNNClusterer(BaseDeepClusterer):
    ...
    kernel_size_encoder : int or list of int, default = [8,5,3]
        Size of convolution kernel in the encoder.
    kernel_size_decoder : int or list of int, default = 1
    ...
    >>> aedcnn=AEDCNNClusterer(n_clusters=2,n_epochs=20,batch_size=4)  # doctest: +SKIP
    ...
    def __init__(
        ...
        self._network = AEDCNNNetwork(
            ...
            num_layers_encoder=self.n_layers_encoder,
            num_layers_decoder=self.n_layers_decoder,
            num_filters_encoder=self.n_filters_encoder,
            num_filters_decoder=self.n_filters_decoder,
