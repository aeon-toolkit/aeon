"""Plot cluster labels with centers marked."""
...
def plot_cluster_labels_and_decision_graph():
    ...
    plt.title("Cluster Labels (Euclidean Distance)", fontsize=16, fontweight="bold")
    ...
    plt.title("Decision Graph (ρ vs δ)", fontsize=16, fontweight="bold")
    ...
    # ============================================================
    # SPIRAL DATASET CLUSTERING RESULTS
    # ============================================================
    # Number of cluster centers: 3
    # Cluster centers indices: [95, 197, 301]
    # Cutoff distance (dc): 2.0000
    # Unique cluster labels: [95, 197, 301]
    #
    # Cluster size breakdown:
    # Cluster 95: 106 points (34.0%)
    # Cluster 197: 101 points (32.4%)
    # Cluster 301: 105 points (33.7%)
    #
    # Cluster centers in decision graph:
    # Center 1 (index 95): position=(22.40, 15.95), ρ=15.2766, δ=30.3078
    # Center 2 (index 197): position=(15.95, 19.90), ρ=10.6970, δ=5.6580
    # Center 3 (index 301): position=(16.15, 12.95), ρ=14.9167, δ=6.6251
    #
    # Density (ρ) range: 1.3081 to 15.2766
    # Delta (δ) range: 0.0707 to 30.3078
    #
    # Threshold analysis:
    # Points with ρ ≥ 8: 83
    # Points with δ ≥ 5: 3
    # Points with both ρ ≥ 8 AND δ ≥ 5: 3
