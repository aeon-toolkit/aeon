...
_AVERAGE_DICT = {
    "mean": mean_average,
    "ba": petitjean_barycenter_average,
    "shift_scale": shift_invariant_average,
    "petitjean_ba": petitjean_barycenter_average,
    "subgradient_ba": subgradient_barycenter_average,
    "kasba": kasba_average,
}


def _resolve_average_callable(
    averaging_method: str | Callable[[np.ndarray, dict], np.ndarray],
    ...
    averaging_method: str or Callable, default='mean'
        ...
        strings are valid: ['mean', 'ba', 'shift_scale', 'petitjean_ba',
        'subgradient_ba', 'kasba'].
