...
from aeon.clustering._private_tslearn_kshape_utils import (TimeSeriesCentroidBasedClusteringMixin,
...
class KShape(ClusterMixin, TimeSeriesCentroidBasedClusteringMixin,
    ...
    Attributes
    ----------
    cluster_centers_ : np.ndarray of shape (sz, d).
        Centroids

    labels_ : np.ndarray of integers with shape (n_ts, ).
    ...
    def fit(self, X, y=None):
        ...
        self._X_fit = X_
        self.norms_ = np.linalg.norm(X_, axis=(1, 2))
