...
class RCluster(BaseClusterer):
    """Time series R Clustering implementation .
       ...
       num_kernels : int , default = 84
            ...
            These kernels are fixed and pre-defined (not random) and are optimized for
    ...
    def __init__(self,
        ...
        self.mini_rocket = MiniRocket(n_kernels= num_kernels,max_dilations_per_kernel=max_dilations_per_kernel,n_jobs=n_jobs)
        self.fit = False
        super().__init__()
