...
from aeon.utils.sklearn import is_sklearn_clusterer
...
class ClustererPipeline(_HeterogenousMetaEstimator, BaseClusterer):
    ...
    Examples
    --------
    >>> from aeon.transformations.panel.pca import PCATransformer
...
class SklearnClustererPipeline(ClustererPipeline):
    ...
    >>> from aeon.datasets import load_unit_test
    >>> from aeon.clustering.compose import SklearnClustererPipeline
    >>> X_train, y_train = load_unit_test(split="train")
    >>> X_test, y_test = load_unit_test(split="test")
