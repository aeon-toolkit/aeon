...
Wraps sktime AutoETS model for forecasting.
...
class SktimeAutoETSForecaster(BaseForecaster):
    """Automatic Exponential Smoothing forecaster from sktime.
    ...
    def _fit(self, y, exog=None):
        ...
        self.model_ = AutoETS(auto=True, sp=season_length)
