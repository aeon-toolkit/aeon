...
class DisjointCNNRegressor(BaseDeepRegressor):
    """Disjoint Convolutional Neural Network regressor.
    ...
    n_filters : ``int`` or list of ``int``, default=``64``
        ...
        as ``n_layers``. If input is ``int``, then a list of the same
        element is created of length ``n_layers``.
    kernel_size : ``int`` or list of ``int``, default=``[8, 5, 5, 3]``
        Size of convolution kernel. If input is set to a list, the length should
        be the same as ``n_layers``. If input is ``int``, then a list of the same
        element is created of length ``n_layers``.
    dilation_rate : ``int`` or list of ``int``, default=``1``
        The dilation rate for convolution. If input is set to a list, the length
        should be the same as ``n_layers``. If input is ``int``, then a list of the same
        element is created of length ``n_layers``.
    strides : ``int`` or list of ``int``, default=``1``
        The strides of the convolution filter. If input is set to a list, the length
        should be the same as ``n_layers``. If input is ``int``, then a list of the same
        element is created of length ``n_layers``.
    padding : ``str`` or list of ``str``, default=``"same"``
        The type of padding used for convolution. If input is set to a list, the length
        should be the same as ``n_layers``. If input is ``str``, then a list of the same
        element is created of length ``n_layers``.
    activation : ``str`` or list of ``str``, default=``"elu"``
        Activation used after the convolution. If input is set to a list, the length
        should be the same as ``n_layers``. If input is ``str``, then a list of the same
        element is created of length ``n_layers``.
    use_bias : ``bool`` or list of ``bool``, default=``True``
        Whether or not to use bias in convolution. If input is set to a list, the length
        should be the same as ``n_layers``. If input is ``bool``, then a list of the same
        element is created of length ``n_layers``.
    kernel_initializer: ``str`` or list of ``str``, default=``"he_uniform"``
        The initialization method of convolution layers. If input is set to a list, the length
        should be the same as ``n_layers``. If input is ``str``, then a list of the same
        element is created of length ``n_layers``.
