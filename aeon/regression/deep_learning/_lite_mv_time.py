...
__all__ = ["IndividualLITE_MVRegressor", "LITE_MVTimeRegressor"]
...
class LITE_MVTimeRegressor(BaseRegressor):
    """LITE_MVTime ensemble Regressor.

    Ensemble of IndividualLITE_MVTimeRegressor objects, as described in [1]_.
    ...
    Examples
    --------
    >>> from aeon.regression.deep_learning import LITE_MVTimeRegressor
    >>> from aeon.datasets import load_unit_test
    >>> X_train, y_train = load_unit_test(split="train")
    >>> X_test, y_test = load_unit_test(split="test")
    >>> lmvtime = LITE_MVTimeRegressor(n_epochs=20,batch_size=4)  # doctest: +SKIP
    ...
    def _fit(self, X, y):
        """Fit the ensemble of IndividualLITE_MVRegressor models.
        ...
        for n in range(0, self.n_regressors):
            rgs = IndividualLITE_MVRegressor(
    ...
    def _predict(self, X) -> np.ndarray:
        """Predict the values of the test set using LITE_MVTime.
...
class IndividualLITE_MVRegressor(BaseDeepRegressor):
    """Single LITE_MV Regressor.
    ...
    Examples
    --------
    >>> from aeon.regression.deep_learning import IndividualLITE_MVRegressor
    >>> from aeon.datasets import load_unit_test
    >>> X_train, y_train = load_unit_test(split="train", return_X_y=True)
    >>> X_test, y_test = load_unit_test(split="test", return_X_y=True)
    >>> litemv = IndividualLITE_MVRegressor(n_epochs=20,batch_size=4)  # doctest: +SKIP
