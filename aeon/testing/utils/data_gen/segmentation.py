...
def piecewise_normal(
    ...
    Examples
    --------
    >>> from from aeon.testing.utils.data_gen import piecewise_normal
...
def piecewise_multinomial(
    ...
    Examples
    --------
    >>> from from aeon.testing.utils.data_gen import piecewise_multinomial
...
def piecewise_poisson(
    ...
    Examples
    --------
    >>> from from aeon.testing.utils.data_gen import piecewise_poisson
