...
class MedianAbsoluteError(BaseForecastingErrorMetricFunc):
    ...
    --------
    >>> import numpy as np
    >>> from aeon.performance_metrics.forecasting import MedianAbsoluteError
    >>> y_true = np.array([3, -0.5, 2, 7, 2])
    >>> y_pred = np.array([2.5, 0.0, 2, 8, 1.25])
...
class MedianSquaredError(BaseForecastingErrorMetricFunc):
    ...
    --------
    >>> import numpy as np
    >>> from aeon.performance_metrics.forecasting import MedianSquaredError
    >>> y_true = np.array([3, -0.5, 2, 7, 2])
    >>> y_pred = np.array([2.5, 0.0, 2, 8, 1.25])
...
class GeometricMeanAbsoluteError(BaseForecastingErrorMetricFunc):
    ...
    --------
    >>> import numpy as np
    >>> from aeon.performance_metrics.forecasting import GeometricMeanAbsoluteError
    >>> y_true = np.array([3, -0.5, 2, 7, 2])
    >>> y_pred = np.array([2.5, 0.0, 2, 8, 1.25])
...
class GeometricMeanSquaredError(BaseForecastingErrorMetricFunc):
    ...
    --------
    >>> import numpy as np
    >>> from aeon.performance_metrics.forecasting import GeometricMeanSquaredError
    >>> y_true = np.array([3, -0.5, 2, 7, 2])
    >>> y_pred = np.array([2.5, 0.0, 2, 8, 1.25])
...
class MeanRelativeAbsoluteError(BaseForecastingErrorMetricFunc):
    ...
    --------
    >>> import numpy as np
    >>> from aeon.performance_metrics.forecasting import MeanRelativeAbsoluteError
    >>> y_true = np.array([3, -0.5, 2, 7, 2])
    >>> y_pred = np.array([2.5, 0.0, 2, 8, 1.25])
...
class MedianRelativeAbsoluteError(BaseForecastingErrorMetricFunc):
    ...
    --------
    >>> import numpy as np
    >>> from aeon.performance_metrics.forecasting import MedianRelativeAbsoluteError
    >>> y_true = np.array([3, -0.5, 2, 7, 2])
    >>> y_pred = np.array([2.5, 0.0, 2, 8, 1.25])
    >>> y_pred_benchmark = y_pred*1.1
...
class MeanAsymmetricError(BaseForecastingErrorMetricFunc):
    ...
    --------
    >>> import numpy as np
    >>> from aeon.performance_metrics.forecasting import MeanAsymmetricError
    >>> y_true = np.array([3, -0.5, 2, 7, 2])
    >>> y_pred = np.array([2.5, 0.0, 2, 8, 1.25])
...
class MeanLinexError(BaseForecastingErrorMetricFunc):
    ...
    --------
    >>> import numpy as np
    >>> from aeon.performance_metrics.forecasting import MeanLinexError
