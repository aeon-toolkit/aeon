...
from aeon.dists_kernels._base import BasePairwiseTransformerPanel
...
class CombinedDistance(_HeterogenousMetaEstimator, BasePairwiseTransformerPanel):
    ...
    Examples
    --------
    >>> from aeon.dists_kernels.algebra import CombinedDistance
    ...
    def get_test_params(cls, parameter_set="default"):
        ...
        """
        from aeon.dists_kernels.compose_tab_to_panel import AggrDist
        from aeon.dists_kernels.dtw import DtwDist
