...
DISTANCES = [
    ...
    {
        "name": "soft_bag",
        "distance": soft_bag_distance,
        "pairwise_distance": soft_bag_pairwise_distance,
        "cost_matrix": soft_bag_cost_matrix,
        "alignment_path": soft_bag_alignment_path,
        "type": DistanceType.ELASTIC,
        "symmetric": True,
        "unequal_support": True,
    },
    {
        "name": "soft_divergence_dtw",
        "distance": soft_dtw_divergence_distance,
        "pairwise_distance": soft_dtw_divergence_pairwise_distance,
        "gradient": soft_dtw_divergence_grad_x,
        "type": DistanceType.ELASTIC,
        "symmetric": True,
        "unequal_support": True,
    },
    {
        "name": "soft_divergence_msm",
        "distance": soft_msm_divergence_distance,
        "pairwise_distance": soft_msm_divergence_pairwise_distance,
        "gradient": soft_msm_divergence_grad_x,
        "type": DistanceType.ELASTIC,
        "symmetric": True,
        "unequal_support": True,
    },
