...
def soft_dtw_cost_matrix(
    ...
    array([[100.        , 221.        , 365.        , 534.        ],
       ...
       [294.        , 308.99999996, 342.99999999, 400.        ],
       [330.        , 342.99999969, 372.99999996, 423.99999999],
       [355.        , 365.99999774, 391.99999969, 436.99999995],
       [371.        , 379.99998319, 401.99999691, 440.99995429],
       [380.        , 386.99975321, 404.99907151, 437.95136565],
       [384.        , 388.98095477, 402.87056572, 427.75811689],
       [385.        , 387.68173033, 396.44055553, 412.43894439]])
    """
    if x.ndim == 1 and y.ndim == 1:
        _x = x.reshape((1, x.shape[0]))
        _y = y.reshape((1, y.shape[0]))
