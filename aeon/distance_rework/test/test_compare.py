import aeon.distance_rework
import aeon.distances
from aeon.distance_rework.test._utils import create_test_distance_numpy, almost_equal, _time_distance
...
def _test_compare(orginal, new):
    ...
    for i in range(10):
        curr_x = x[i]
        curr_y = y[i]
        almost_equal(orginal(curr_x, curr_y), new(curr_x, curr_y))
