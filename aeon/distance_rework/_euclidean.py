...
def euclidean_pairwise_distance(X: np.ndarray) -> np.ndarray:
    ...
    --------
    >>> import numpy as np
    >>> from aeon.distance_rework import euclidean_pairwise_distance
...
def euclidean_from_single_to_multiple_distance(
    ...
    --------
    >>> import numpy as np
    >>> from aeon.distance_rework import euclidean_from_single_to_multiple_distance
    >>> x = np.array([[1, 2, 3, 6]])
...
def euclidean_from_multiple_to_multiple_distance(
    ...
    --------
    >>> import numpy as np
    >>> from aeon.distance_rework import euclidean_from_multiple_to_multiple_distance
