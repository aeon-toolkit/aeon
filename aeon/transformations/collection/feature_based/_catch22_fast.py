"""Catch22Fast features.

A transformer for the Catch22Fast features.
"""
...
class Catch22Fast(BaseCollectionTransformer):
    """Canonical Time-series Characteristics (Catch22Fast).
    ...
    outlier_norm : bool, optional, default=False
        ...
        outlier Catch22Fast features, which can take a while to process for large values
    ...
    replace_nans : bool, default=False
        Replace NaN or inf values from the Catch22Fast transform with 0.
    ...
    See Also
    --------
    Catch22FastClassifier

    Notes
    -----
    Original Catch22Fast package implementations:
    https://github.com/DynamicsAndNeuralSystems/Catch22Fast

    For the Java version, see
    https://github.com/uea-machine-learning/tsml/blob/master/src/main/java
    /tsml/transformers/Catch22Fast.java
    ...
    >>> tnf = Catch22Fast(replace_nans=True)
    >>> tnf.fit(X)
    Catch22Fast(...)
    ...
    def _transform(self, X, y=None):
        ...
        features = [
            Catch22Fast._DN_HistogramMode_5,
            Catch22Fast._DN_HistogramMode_10,
            Catch22Fast._CO_f1ecac,
            Catch22Fast._CO_FirstMin_ac,
            Catch22Fast._CO_HistogramAMI_even_2_5,
            Catch22Fast._CO_trev_1_num,
            Catch22Fast._MD_hrv_classic_pnn40,
            Catch22Fast._SB_BinaryStats_mean_longstretch1,
            Catch22Fast._SB_TransitionMatrix_3ac_sumdiagcov,
            Catch22Fast._PD_PeriodicityWang_th0_01,
            Catch22Fast._CO_Embed2_Dist_tau_d_expfit_meandiff,
            Catch22Fast._IN_AutoMutualInfoStats_40_gaussian_fmmi,
            Catch22Fast._FC_LocalSimple_mean1_tauresrat,
            Catch22Fast._DN_OutlierInclude_p_001_mdrmd,
            Catch22Fast._DN_OutlierInclude_n_001_mdrmd,
            Catch22Fast._SP_Summaries_welch_rect_area_5_1,
            Catch22Fast._SB_BinaryStats_diff_longstretch0,
            Catch22Fast._SB_MotifThree_quantile_hh,
            Catch22Fast._SC_FluctAnal_2_rsrangefit_50_1_logi_prop_r1,
            Catch22Fast._SC_FluctAnal_2_dfa_50_1_2_logi_prop_r1,
            Catch22Fast._SP_Summaries_welch_rect_centroid,
            Catch22Fast._FC_LocalSimple_mean3_stderr,
        ]
