...
expected_unit_test["Rocket"] = np.array(
    [
        [0.375, 0.6415654, 0.5, 6.1307883, 0.45833334],
        [0.25, 0.6614452, 0.5, 5.6384306, 0.5416667],
        [0.29166666, 0.63233125, 0.5416667, 5.9403105, 0.5],
        [0.29166666, 0.48960805, 0.625, 5.2112703, 0.5],
        [0.33333334, 0.6169336, 0.5833333, 5.4417562, 0.5],
    ],
    dtype=np.float32,
)
