...
def _handle_aeon_signatures(check_fitted=False, force_numpy=False):
    """Handle the aeon checks in signature modules, decorator.
    ...
    form [batch, length channels]. This function performs the aeon checks,
    ...
    check_fitted : bool, optional, default=False
        Whether to invoke aeons `check_fitted` function at the start.
    ...
    def real_decorator(func):
        """Handle the aeon checks and convert the data to numpy, decorator."""
