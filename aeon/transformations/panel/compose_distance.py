...
class DistanceFeatures(BaseTransformer):
    ...
    >>> from aeon.transformations.panel.compose_distance import DistanceFeatures
    ...
    def __init__(self, distance=None, distance_mtype=None, flatten_hierarchy=False):
        ...
        from aeon.dists_kernels import BasePairwiseTransformerPanel, FlatDist, ScipyDist
