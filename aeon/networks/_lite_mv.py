"""LITE Multivariate Network (LITEMVNetwork)."""

__maintainer__ = ["hadifawaz1999"]
__all__ = ["LITE_MVNetwork"]


from aeon.networks.base import BaseDeepLearningNetwork


class LITE_MVNetwork(BaseDeepLearningNetwork):
    """LITE Multivariate Network.

    LITE Multivariate deep neural network architecture from [1]_.
