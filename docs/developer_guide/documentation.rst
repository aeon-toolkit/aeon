...
In the event a term is not already in the glossary, developers should add the term to the glossary (sktime/docs/glossary.rst) and include a reference (as shown above)
to the added term.
...
in `docs/ <https://github.com/sktime/sktime/tree/main/docs/>`_.
The main configuration file for sphinx is
`conf.py <https://github.com/sktime/sktime/blob/main/docs/conf.py>`__
and the main page is
`index.rst <https://github.com/sktime/sktime/blob/main/docs/index.rst>`__.
