...
Join the aeon team for a summer full of coding, learning and fun. Be part of our diverse community and join our efforts to advance machine learning and time series analysis capabilities, by helping create one of the first comprehensive time series ML toolboxes!
...
- **April 19, 18:00 (UTC)**: You must complete an entrance task, the aeon application form and GSoC proposal by this deadline.
...
### Entrace task, aeon application and GSoC proposal

The deadline to complete all of these is **April 19, 18:00 (UTC)**.

1. Entrance task. Make a pull request (PR) to aeon to show you are able to contribute meaningfully.
    - Your PR does not need to be merged at the time of application.
    - To find out how to contribute to aeon, look at our [new contributor starter issue](https://github.com/sktime/sktime/issues/1147) and [developer guide](https://www.aeon-toolkit.org/en/latest/developer_guide.html).
...
2. Fill in and submit the aeon application form at (https://forms.gle/MVcf9Q45Ui1ByMxM8).
...
- Rejection. Though this will be disheartening for you, this is only a rejection for GSoC (which is particularly demanding of participants) and should not discourage you from pursuing open source contributions, either with aeon or another package. E.g. you may still be eligible for our (unpaid) 1-1 mentoring.

### Getting feedback on proposal
If you want feedback on your proposal, then you must complete the entrance task, the aeon application form and a GSoC proposal by April 12, 18:00 (UTC).

1. Entrance task. Same as above.
2. Fill in and submit the aeon application form. Same as above except:
...
If successful in the above steps, we will invite you to a structured interview (ca. 30 to 60 minutes length; to be finalised) with core community members of aeon.
...
- we will ask about your motivation to join aeon, your previous experience, your suitability for the specified project, and technical questions on data science and Python.
...
* Conditional acceptance. This means you are in our shortlist sent to GSoC.  This means likely - but not guaranteed - acceptance to the aeon GSoC program.
* A rejection. This means you are not in our shortlist sent to GSoC for 2022.
  - We understand this will be disheartening for you, but this is only a rejection for GSoC, which is particularly demanding of participants. We will always welcome anybody interested in joining aeon outside of GSoC.
...
- join the [aeon slack workspace]https://join.slack.com/t/scikit-timeworkspace/shared_invite/zt-1pkhua342-W_W24XuAZt2JZU1GniK2YA and say Hi
- follow us [twitter](https://twitter.com/aeon_toolkit)
...
- You follow our [Code of Conduct](https://www.aeon-toolkit.org/en/stable/get_involved/code_of_conduct.html).
- You work full time on your GSoC project.
- You maintain daily contact with your mentor(s).
- You engage with the aeon community and other GSoC participants.
...
- We follow the [Code of Conduct](https://www.aeon-toolkit.org/en/stable/get_involved/code_of_conduct.html).
...
- The opportunity to engage and socialise with the aeon community and other GSoC participants.
- The opportunity to become a core developer of aeon.


## Projects

For potential projects, see our [list of suggested projects](https://github.com/aeon/mentoring/blob/main/internships/projects_2022.md) and [good first issues](https://github.com/sktime/sktime/labels/good%20first%20issue).
...
- [aeon's mentoring](https://github.com/aeon/mentoring)
- [GSoC project page](https://summerofcode.withgoogle.com/programs/2022/organizations/aeon)
