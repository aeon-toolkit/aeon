...
- The Hydra and MultiRocketHydra algorithms have been implemented for regression module ({user}`MatthewMiddlehurst`)
...
The following have contributed to this release through a collective 47 GitHub Pull Requests:
