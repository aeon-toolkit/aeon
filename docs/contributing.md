...
1. Say hello in the `introductions` or `contributors` channel on [Discord](https://discord.gg/W4PrQ4Dm7)
...
or ask in [Discord](https://discord.gg/W4PrQ4Dm7). Follow the PR template, template comments and checklist. Please make
...
reach out to us on [Discord](https://discord.gg/W4PrQ4Dm7)
